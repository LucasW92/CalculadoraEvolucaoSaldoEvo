...
public static class Mensagens
{
    ...
    public const string PrazoMesesInvalido = "O prazo deve ser maior que zero e menor ou igual a 1200 meses.";
    ...
    public const string OverflowErroCalculo = "O resultado da simulação excedeu o limite máximo permitido. Por favor, reduza algum dos parâmetros de simulação.";
}
